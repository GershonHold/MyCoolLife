 ...
 * 记步主页
 */
public class LocalModeMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView check_history_steps;
...
//        tv_intro = findViewById(R.id.tv_intro);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.local_mode_activity_main);
        assignViews();
...
//        tv_intro.setText("个人简介："+ JsonUtils.getUserInfoBeanJsonList(userInfoString).get(0).getIntro());
    ...
    private void setupService() {
        ...
        bundleForService.putBoolean("localmode", true);
...
//                startActivity(new Intent(this, HistoryActivity.class));
                ...
                Bundle bundleForLocalHistoryActivity = new Bundle();
                bundleForLocalHistoryActivity.putString("name",name);
                intent.putExtras(bundleForLocalHistoryActivity);
