...
public class GetOneDayRankDataThread extends Thread {
    ...
    public GetOneDayRankDataThread(String path, String date) {
        this.path = path;
        this.date = date;
    }
    ...
    public void run() {
        try {
            ...
            String data = "date=" + URLEncoder.encode(date, "utf-8") ;//设置数据
