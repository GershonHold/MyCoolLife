...
public class GetUsersAllStepsDataThread extends Thread {
    ...
    public GetUsersAllStepsDataThread(String path, int usr_id) {
        this.path = path;
        this.usr_id = usr_id;
    }
    ...
    public void run() {
        try {
            ...
            String data = "usr_id=" + URLEncoder.encode(String.valueOf(usr_id), "utf-8");//设置数据
